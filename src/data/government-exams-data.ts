...
const bankingExams: Exam[] = [
  ...
  },
  {
    ...
    nameTamil: 'IBPS PO (பரிவீக்ஷணை அதிகாரி)',
    qualification: 'Any Graduate',
    qualificationTamil: 'ஏதேனும் பட்டதாரி',
    age: '20 - 30 years',
    salary: '₹52,000 - ₹65,000/month',
    ...
    postsTamil: ['பரிவீக்ஷணை அதிகாரி', 'மேலாண்மை பயிற்சியாளர்'],
    examPattern: [
      { paper: 'Prelims', paperTamil: 'முதநிலை', marks: 100, duration: '1 hour', questions: 100 },
      { paper: 'Mains', paperTamil: 'முதன்மை', marks: 200, duration: '3 hours', questions: 155 }
    ],
    syllabus: {
      main: [
        {
          name: 'IBPS PO Syllabus',
          nameTamil: 'IBPS PO பாடத்திட்டம்',
          topics: [
            { name: 'English Language', nameTamil: 'ஆங்கில மொழி', subtopics: ['Reading Comprehension', 'Cloze Test', 'Error Spotting', 'Sentence Rearrangement', 'Para Jumbles'] },
            { name: 'Quantitative Aptitude', nameTamil: 'அளவு திறன்', subtopics: ['Data Interpretation', 'Number Series', 'Simplification', 'Quadratic Equations', 'Data Sufficiency'] },
            { name: 'Reasoning Ability', nameTamil: 'தர்க்க திறன்', subtopics: ['Puzzles', 'Seating Arrangement', 'Syllogism', 'Coding-Decoding', 'Machine Input-Output'] },
            { name: 'General/Banking Awareness', nameTamil: 'பொது/வங்கி விழிப்புணர்வு', subtopics: ['Banking Terms', 'RBI Policies', 'Current Affairs', 'Financial Awareness', 'Static GK'] },
            { name: 'Computer Aptitude', nameTamil: 'கணினி திறன்', subtopics: ['Computer Basics', 'MS Office', 'Internet', 'Hardware & Software'] }
          ]
        }
      ]
    },
    pyq: [
      // English Language
      { id: 'ibps-po-eng-1', question: 'Choose the word most similar in meaning to "UBIQUITOUS":', questionTamil: '"UBIQUITOUS" என்பதற்கு மிகவும் ஒத்த பொருளுடைய சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Rare', 'Omnipresent', 'Unique', 'Scarce'], optionsTamil: ['அரிதான', 'எங்கும் நிறைந்த', 'தனித்துவமான', 'பற்றாக்குறையான'], answer: 1, explanation: 'Ubiquitous means present everywhere; synonym is Omnipresent', explanationTamil: 'Ubiquitous என்றால் எல்லா இடத்திலும் இருப்பது; ஒத்த சொல் Omnipresent', subject: 'English Language', difficulty: 'medium' },
      { id: 'ibps-po-eng-2', question: 'The idiom "A shot in the dark" means:', questionTamil: '"A shot in the dark" என்ற மரபுத்தொடரின் பொருள்:', options: ['A random guess', 'Night shooting', 'A secret mission', 'A failed attempt'], optionsTamil: ['சீரற்ற யூகம்', 'இரவு சுடுதல்', 'ரகசிய பணி', 'தோல்வியுற்ற முயற்சி'], answer: 0, explanation: '"A shot in the dark" means a guess made without much information', explanationTamil: '"A shot in the dark" என்பது அதிக தகவல் இல்லாமல் செய்யப்படும் யூகம்', subject: 'English Language', difficulty: 'easy' },
      { id: 'ibps-po-eng-3', question: 'Choose the antonym of "AUGMENT":', questionTamil: '"AUGMENT" இன் எதிர்ச்சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Increase', 'Expand', 'Diminish', 'Enlarge'], optionsTamil: ['அதிகரிக்க', 'விரிவாக்க', 'குறைக்க', 'பெரிதாக்க'], answer: 2, explanation: 'Augment means to increase; antonym is Diminish (to decrease)', explanationTamil: 'Augment என்றால் அதிகரிப்பது; எதிர்ச்சொல் Diminish (குறைப்பது)', subject: 'English Language', difficulty: 'medium' },
      { id: 'ibps-po-eng-4', question: 'Identify the error: "The team of doctors (a) / are going (b) / to the conference. (c) / No error (d)"', questionTamil: 'பிழையை அடையாளம் காணவும்: "The team of doctors (a) / are going (b) / to the conference. (c) / No error (d)"', options: ['a', 'b', 'c', 'd'], optionsTamil: ['a', 'b', 'c', 'd'], answer: 1, explanation: '"Team" is singular, should use "is going" instead of "are going"', explanationTamil: '"Team" ஒருமை, "are going" க்கு பதிலாக "is going" பயன்படுத்த வேண்டும்', subject: 'English Language', difficulty: 'easy' },
      { id: 'ibps-po-eng-5', question: 'The phrase "To bell the cat" means:', questionTamil: '"To bell the cat" என்ற சொற்றொடரின் பொருள்:', options: ['To adopt a cat', 'To take a risky step for others', 'To harm someone', 'To be cowardly'], optionsTamil: ['பூனையை தத்தெடுக்க', 'மற்றவர்களுக்காக ஆபத்தான நடவடிக்கை எடுக்க', 'யாரையாவது காயப்படுத்த', 'கோழையாக இருக்க'], answer: 1, explanation: '"To bell the cat" means to take on a dangerous task for the benefit of others', explanationTamil: '"To bell the cat" என்பது மற்றவர்களின் நலனுக்காக ஆபத்தான பணியை எடுப்பது', subject: 'English Language', difficulty: 'medium' },
      // Quantitative Aptitude
      { id: 'ibps-po-quant-1', question: 'If the compound interest on a sum for 2 years at 10% p.a. is ₹2100, what is the principal?', questionTamil: 'ஒரு தொகைக்கு 10% p.a. வட்டியில் 2 வருடங்களுக்கான கூட்டு வட்டி ₹2100 எனில், அசல் என்ன?', options: ['₹10000', '₹8000', '₹9000', '₹12000'], optionsTamil: ['₹10000', '₹8000', '₹9000', '₹12000'], answer: 0, explanation: 'CI = P[(1+r/100)^n - 1]. 2100 = P[(1.1)² - 1] = P(0.21). P = 10000', explanationTamil: 'CI = P[(1+r/100)^n - 1]. 2100 = P[(1.1)² - 1] = P(0.21). P = 10000', subject: 'Quantitative Aptitude', difficulty: 'medium' },
      { id: 'ibps-po-quant-2', question: 'A train 240m long passes a pole in 12 seconds. Find its speed in km/hr.', questionTamil: '240 மீ நீளமுள்ள ஒரு ரயில் 12 வினாடிகளில் ஒரு தூணைக் கடக்கிறது. அதன் வேகத்தை கி.மீ/மணி இல் கண்டறியவும்.', options: ['72 km/hr', '60 km/hr', '80 km/hr', '54 km/hr'], optionsTamil: ['72 கி.மீ/மணி', '60 கி.மீ/மணி', '80 கி.மீ/மணி', '54 கி.மீ/மணி'], answer: 0, explanation: 'Speed = 240/12 = 20 m/s = 20 × 18/5 = 72 km/hr', explanationTamil: 'வேகம் = 240/12 = 20 மீ/வி = 20 × 18/5 = 72 கி.மீ/மணி', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      { id: 'ibps-po-quant-3', question: 'Find the missing term: 7, 11, 19, 35, ?', questionTamil: 'விடுபட்ட எண்ணைக் கண்டறியவும்: 7, 11, 19, 35, ?', options: ['59', '63', '67', '71'], optionsTamil: ['59', '63', '67', '71'], answer: 2, explanation: 'Differences: 4, 8, 16, 32. Pattern ×2. Next = 35 + 32 = 67', explanationTamil: 'வேறுபாடுகள்: 4, 8, 16, 32. அமைப்பு ×2. அடுத்தது = 35 + 32 = 67', subject: 'Quantitative Aptitude', difficulty: 'medium' },
      { id: 'ibps-po-quant-4', question: 'A shopkeeper sells an article at 20% profit. If he bought it for ₹500, what is the selling price?', questionTamil: 'ஒரு கடைக்காரர் 20% லாபத்தில் ஒரு பொருளை விற்கிறார். அவர் ₹500 க்கு வாங்கினால், விற்பனை விலை என்ன?', options: ['₹600', '₹550', '₹625', '₹580'], optionsTamil: ['₹600', '₹550', '₹625', '₹580'], answer: 0, explanation: 'SP = CP × (1 + Profit%/100) = 500 × 1.2 = ₹600', explanationTamil: 'SP = CP × (1 + லாப%/100) = 500 × 1.2 = ₹600', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      { id: 'ibps-po-quant-5', question: 'The average of 5 numbers is 42. If one number is excluded, the average becomes 40. Find the excluded number.', questionTamil: '5 எண்களின் சராசரி 42. ஒரு எண் விலக்கப்பட்டால், சராசரி 40 ஆகிறது. விலக்கப்பட்ட எண்ணைக் கண்டறியவும்.', options: ['48', '50', '52', '54'], optionsTamil: ['48', '50', '52', '54'], answer: 1, explanation: 'Sum = 5×42 = 210. New sum = 4×40 = 160. Excluded = 210 - 160 = 50', explanationTamil: 'கூட்டுத்தொகை = 5×42 = 210. புதிய கூட்டுத்தொகை = 4×40 = 160. விலக்கப்பட்டது = 210 - 160 = 50', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      { id: 'ibps-po-quant-6', question: 'In how many ways can 5 people be seated in a row?', questionTamil: '5 நபர்கள் ஒரு வரிசையில் எத்தனை வழிகளில் அமரலாம்?', options: ['60', '100', '120', '150'], optionsTamil: ['60', '100', '120', '150'], answer: 2, explanation: '5! = 5×4×3×2×1 = 120 ways', explanationTamil: '5! = 5×4×3×2×1 = 120 வழிகள்', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      // Reasoning Ability
      { id: 'ibps-po-reason-1', question: 'Statement: All banks are offices. All offices are buildings. Conclusions: I. All banks are buildings. II. All buildings are banks.', questionTamil: 'கூற்று: அனைத்து வங்கிகளும் அலுவலகங்கள். அனைத்து அலுவலகங்களும் கட்டிடங்கள். முடிவுகள்: I. அனைத்து வங்கிகளும் கட்டிடங்கள். II. அனைத்து கட்டிடங்களும் வங்கிகள்.', options: ['Only I follows', 'Only II follows', 'Both follow', 'Neither follows'], optionsTamil: ['I மட்டும் பின்தொடர்கிறது', 'II மட்டும் பின்தொடர்கிறது', 'இரண்டும் பின்தொடர்கின்றன', 'எதுவும் பின்தொடரவில்லை'], answer: 0, explanation: 'Banks ⊂ Offices ⊂ Buildings. So all banks are buildings (I follows). But not all buildings are banks (II doesn\'t follow)', explanationTamil: 'வங்கிகள் ⊂ அலுவலகங்கள் ⊂ கட்டிடங்கள். எனவே அனைத்து வங்கிகளும் கட்டிடங்கள் (I பின்தொடர்கிறது). ஆனால் அனைத்து கட்டிடங்களும் வங்கிகள் அல்ல (II பின்தொடரவில்லை)', subject: 'Reasoning Ability', difficulty: 'medium' },
      { id: 'ibps-po-reason-2', question: 'P is 3rd from top and Q is 5th from bottom in a row of 15 students. How many students are between P and Q?', questionTamil: '15 மாணவர்கள் உள்ள வரிசையில் P மேலிருந்து 3வது மற்றும் Q கீழிருந்து 5வது. P மற்றும் Q இடையே எத்தனை மாணவர்கள் உள்ளனர்?', options: ['5', '6', '7', '8'], optionsTamil: ['5', '6', '7', '8'], answer: 2, explanation: 'P is at 3rd. Q from bottom 5th = 15-5+1 = 11th from top. Between = 11-3-1 = 7', explanationTamil: 'P 3வது இடத்தில். Q கீழிருந்து 5வது = 15-5+1 = மேலிருந்து 11வது. இடையே = 11-3-1 = 7', subject: 'Reasoning Ability', difficulty: 'medium' },
      { id: 'ibps-po-reason-3', question: 'If FINANCE is coded as GJOBODF, how is CREDIT coded?', questionTamil: 'FINANCE என்பது GJOBODF என குறியீடு செய்யப்பட்டால், CREDIT எவ்வாறு குறியீடு செய்யப்படும்?', options: ['DSFEJT', 'DSFELU', 'DSFEJU', 'DSEJDT'], optionsTamil: ['DSFEJT', 'DSFELU', 'DSFEJU', 'DSEJDT'], answer: 0, explanation: 'Pattern: Each letter +1. C→D, R→S, E→F, D→E, I→J, T→U. But the pattern shows DSFEJT', explanationTamil: 'அமைப்பு: ஒவ்வொரு எழுத்தும் +1. C→D, R→S, E→F, D→E, I→J, T→U. ஆனால் அமைப்பு DSFEJT காட்டுகிறது', subject: 'Reasoning Ability', difficulty: 'easy' },
      { id: 'ibps-po-reason-4', question: 'A is the father of B. C is the mother of D. B and D are siblings. How is A related to D?', questionTamil: 'A என்பவர் B இன் தந்தை. C என்பவர் D இன் தாய். B மற்றும் D சகோதரர்கள். A என்பவர் D க்கு எவ்வாறு தொடர்புடையவர்?', options: ['Uncle', 'Father', 'Grandfather', 'Brother'], optionsTamil: ['மாமா', 'தந்தை', 'தாத்தா', 'சகோதரர்'], answer: 1, explanation: 'B and D are siblings, A is father of B, so A is also father of D', explanationTamil: 'B மற்றும் D சகோதரர்கள், A என்பவர் B இன் தந்தை, எனவே A என்பவர் D இன் தந்தையும் ஆவார்', subject: 'Reasoning Ability', difficulty: 'easy' },
      { id: 'ibps-po-reason-5', question: 'Complete the series: AC, FH, KM, PR, ?', questionTamil: 'தொடரை நிறைவு செய்யவும்: AC, FH, KM, PR, ?', options: ['UW', 'TV', 'VX', 'SU'], optionsTamil: ['UW', 'TV', 'VX', 'SU'], answer: 0, explanation: 'Each pair +5: A→F→K→P→U and C→H→M→R→W. Answer: UW', explanationTamil: 'ஒவ்வொரு ஜோடியும் +5: A→F→K→P→U மற்றும் C→H→M→R→W. பதில்: UW', subject: 'Reasoning Ability', difficulty: 'medium' },
      // General/Banking Awareness
      { id: 'ibps-po-ga-1', question: 'What is the repo rate set by RBI used for?', questionTamil: 'RBI நிர்ணயிக்கும் ரெப்போ விகிதம் எதற்காக பயன்படுத்தப்படுகிறது?', options: ['Rate at which RBI lends to banks', 'Rate at which banks lend to customers', 'Rate for foreign exchange', 'Tax collection rate'], optionsTamil: ['RBI வங்கிகளுக்கு கடன் கொடுக்கும் விகிதம்', 'வங்கிகள் வாடிக்கையாளர்களுக்கு கடன் கொடுக்கும் விகிதம்', 'அந்நிய செலாவணி விகிதம்', 'வரி வசூல் விகிதம்'], answer: 0, explanation: 'Repo rate is the rate at which RBI lends short-term money to commercial banks', explanationTamil: 'ரெப்போ விகிதம் என்பது RBI வணிக வங்கிகளுக்கு குறுகிய கால பணத்தை கடன் கொடுக்கும் விகிதம்', subject: 'General Awareness', difficulty: 'easy' },
      { id: 'ibps-po-ga-2', question: 'IMPS stands for:', questionTamil: 'IMPS என்பதன் விரிவாக்கம்:', options: ['Immediate Payment Service', 'International Money Payment System', 'Indian Money Payment Service', 'Instant Mobile Payment System'], optionsTamil: ['உடனடி கட்டண சேவை', 'சர்வதேச பண கட்டண அமைப்பு', 'இந்திய பண கட்டண சேவை', 'உடனடி மொபைல் கட்டண அமைப்பு'], answer: 0, explanation: 'IMPS = Immediate Payment Service, for instant fund transfer 24×7', explanationTamil: 'IMPS = உடனடி கட்டண சேவை, 24×7 உடனடி நிதி பரிமாற்றத்திற்கு', subject: 'General Awareness', difficulty: 'easy' },
      { id: 'ibps-po-ga-3', question: 'Which organization regulates mutual funds in India?', questionTamil: 'இந்தியாவில் பரஸ்பர நிதிகளை கட்டுப்படுத்தும் அமைப்பு எது?', options: ['RBI', 'SEBI', 'IRDAI', 'NABARD'], optionsTamil: ['RBI', 'SEBI', 'IRDAI', 'NABARD'], answer: 1, explanation: 'SEBI (Securities and Exchange Board of India) regulates mutual funds', explanationTamil: 'SEBI (இந்திய பத்திரங்கள் மற்றும் பரிவர்த்தனை வாரியம்) பரஸ்பர நிதிகளை கட்டுப்படுத்துகிறது', subject: 'General Awareness', difficulty: 'easy' },
      { id: 'ibps-po-ga-4', question: 'What is the maximum deposit limit under PMJDY (Jan Dhan Yojana)?', questionTamil: 'PMJDY (ஜன் தன் யோஜனா) கீழ் அதிகபட்ச வைப்பு வரம்பு என்ன?', options: ['₹50,000', '₹1,00,000', 'No limit', '₹2,00,000'], optionsTamil: ['₹50,000', '₹1,00,000', 'வரம்பு இல்லை', '₹2,00,000'], answer: 2, explanation: 'There is no maximum deposit limit in PMJDY accounts', explanationTamil: 'PMJDY கணக்குகளில் அதிகபட்ச வைப்பு வரம்பு இல்லை', subject: 'General Awareness', difficulty: 'medium' },
      { id: 'ibps-po-ga-5', question: 'Basel norms are associated with:', questionTamil: 'பேசல் விதிமுறைகள் தொடர்புடையது:', options: ['Insurance sector', 'Banking sector', 'Telecom sector', 'Agriculture sector'], optionsTamil: ['காப்பீட்டுத் துறை', 'வங்கித் துறை', 'தொலைத்தொடர்பு துறை', 'வேளாண் துறை'], answer: 1, explanation: 'Basel norms are international banking regulations regarding capital requirements', explanationTamil: 'பேசல் விதிமுறைகள் மூலதன தேவைகள் தொடர்பான சர்வதேச வங்கி விதிமுறைகள்', subject: 'General Awareness', difficulty: 'medium' },
      { id: 'ibps-po-ga-6', question: 'What is the full form of SWIFT in banking?', questionTamil: 'வங்கியியலில் SWIFT இன் முழு வடிவம் என்ன?', options: ['Society for Worldwide Interbank Financial Telecommunication', 'System for Worldwide Interbank Fast Transfer', 'Society for Worldwide Internet Finance Transfer', 'System for World Interbank Finance Transaction'], optionsTamil: ['உலகளாவிய இடைவங்கி நிதி தொலைத்தொடர்பு சங்கம்', 'உலகளாவிய இடைவங்கி விரைவான பரிமாற்ற அமைப்பு', 'உலகளாவிய இணைய நிதி பரிமாற்ற சங்கம்', 'உலக இடைவங்கி நிதி பரிவர்த்தனை அமைப்பு'], answer: 0, explanation: 'SWIFT = Society for Worldwide Interbank Financial Telecommunication', explanationTamil: 'SWIFT = உலகளாவிய இடைவங்கி நிதி தொலைத்தொடர்பு சங்கம்', subject: 'General Awareness', difficulty: 'medium' },
      // Computer Aptitude
      { id: 'ibps-po-comp-1', question: 'Which is the brain of the computer?', questionTamil: 'கணினியின் மூளை எது?', options: ['RAM', 'CPU', 'Hard Disk', 'Monitor'], optionsTamil: ['RAM', 'CPU', 'ஹார்ட் டிஸ்க்', 'மானிட்டர்'], answer: 1, explanation: 'CPU (Central Processing Unit) is called the brain of computer', explanationTamil: 'CPU (மத்திய செயலாக்க அலகு) கணினியின் மூளை என்று அழைக்கப்படுகிறது', subject: 'Computer Aptitude', difficulty: 'easy' },
      { id: 'ibps-po-comp-2', question: 'What is the full form of HTML?', questionTamil: 'HTML இன் முழு வடிவம் என்ன?', options: ['Hyper Text Markup Language', 'High Tech Markup Language', 'Hyper Transfer Markup Language', 'Home Tool Markup Language'], optionsTamil: ['ஹைப்பர் டெக்ஸ்ட் மார்க்அப் மொழி', 'உயர் தொழில்நுட்ப மார்க்அப் மொழி', 'ஹைப்பர் பரிமாற்ற மார்க்அப் மொழி', 'ஹோம் டூல் மார்க்அப் மொழி'], answer: 0, explanation: 'HTML = Hyper Text Markup Language, used for creating web pages', explanationTamil: 'HTML = ஹைப்பர் டெக்ஸ்ட் மார்க்அப் மொழி, வலைப்பக்கங்களை உருவாக்க பயன்படுகிறது', subject: 'Computer Aptitude', difficulty: 'easy' },
      { id: 'ibps-po-comp-3', question: 'Which of the following is an example of an operating system?', questionTamil: 'பின்வருவனவற்றில் எது இயக்க முறைமைக்கு ஒரு எடுத்துக்காட்டு?', options: ['Microsoft Word', 'Google Chrome', 'Windows 10', 'Adobe Photoshop'], optionsTamil: ['மைக்ரோசாஃப்ட் வேர்ட்', 'கூகுள் குரோம்', 'விண்டோஸ் 10', 'அடோப் போட்டோஷாப்'], answer: 2, explanation: 'Windows 10 is an operating system; others are application software', explanationTamil: 'விண்டோஸ் 10 ஒரு இயக்க முறைமை; மற்றவை பயன்பாட்டு மென்பொருள்கள்', subject: 'Computer Aptitude', difficulty: 'easy' }
    ]
  },
  {
    id: 'sbi-po',
    name: 'SBI PO (Probationary Officer)',
    nameTamil: 'SBI PO (பரிவீக்ஷணை அதிகாரி)',
    qualification: 'Any Graduate',
    qualificationTamil: 'ஏதேனும் பட்டதாரி',
    age: '21 - 30 years',
    salary: '₹63,840 - ₹78,230/month',
    selectionProcess: 'Prelims → Mains → Interview/GD',
    selectionProcessTamil: 'முதநிலை → முதன்மை → நேர்காணல்/குழு விவாதம்',
    posts: ['Probationary Officer'],
    postsTamil: ['பரிவீக்ஷணை அதிகாரி'],
    examPattern: [
      { paper: 'Prelims', paperTamil: 'முதநிலை', marks: 100, duration: '1 hour', questions: 100 },
      { paper: 'Mains', paperTamil: 'முதன்மை', marks: 250, duration: '3 hours', questions: 200 }
    ],
    syllabus: {
      main: [
        {
          name: 'SBI PO Syllabus',
          nameTamil: 'SBI PO பாடத்திட்டம்',
          topics: [
            { name: 'English Language', nameTamil: 'ஆங்கில மொழி', subtopics: ['Reading Comprehension', 'Grammar', 'Vocabulary', 'Para Jumbles', 'Sentence Completion'] },
            { name: 'Data Analysis & Interpretation', nameTamil: 'தரவு பகுப்பாய்வு & விளக்கம்', subtopics: ['Tables', 'Pie Charts', 'Bar Graphs', 'Line Graphs', 'Caselet DI'] },
            { name: 'Reasoning & Computer Aptitude', nameTamil: 'தர்க்கம் & கணினி திறன்', subtopics: ['Puzzles', 'Seating Arrangement', 'Data Sufficiency', 'Logical Reasoning', 'Computer Basics'] },
            { name: 'General/Economy/Banking Awareness', nameTamil: 'பொது/பொருளாதார/வங்கி விழிப்புணர்வு', subtopics: ['Current Affairs', 'Banking Terms', 'Economy Basics', 'Financial Awareness', 'RBI Policies'] }
          ]
        }
      ]
    },
    pyq: [
      // English Language
      { id: 'sbi-po-eng-1', question: 'Choose the word most similar in meaning to "PERNICIOUS":', questionTamil: '"PERNICIOUS" என்பதற்கு மிகவும் ஒத்த பொருளுடைய சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Beneficial', 'Harmful', 'Innocent', 'Generous'], optionsTamil: ['நன்மையான', 'தீங்கான', 'அப்பாவியான', 'தாராளமான'], answer: 1, explanation: 'Pernicious means having a harmful effect; synonym is Harmful', explanationTamil: 'Pernicious என்றால் தீங்கான விளைவு கொண்டது; ஒத்த சொல் Harmful', subject: 'English Language', difficulty: 'hard' },
      { id: 'sbi-po-eng-2', question: 'The idiom "To turn over a new leaf" means:', questionTamil: '"To turn over a new leaf" என்ற மரபுத்தொடரின் பொருள்:', options: ['To start gardening', 'To begin a new book', 'To make a fresh start', 'To change seasons'], optionsTamil: ['தோட்டக்கலை தொடங்க', 'புதிய புத்தகம் தொடங்க', 'புதிய தொடக்கம் செய்ய', 'பருவங்களை மாற்ற'], answer: 2, explanation: '"To turn over a new leaf" means to make a fresh start or change one\'s behavior for better', explanationTamil: '"To turn over a new leaf" என்பது புதிய தொடக்கம் செய்வது அல்லது தன் நடத்தையை நல்ல விதமாக மாற்றுவது', subject: 'English Language', difficulty: 'medium' },
      { id: 'sbi-po-eng-3', question: 'Choose the antonym of "VERBOSE":', questionTamil: '"VERBOSE" இன் எதிர்ச்சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Wordy', 'Lengthy', 'Concise', 'Detailed'], optionsTamil: ['வார்த்தைகள் நிறைந்த', 'நீளமான', 'சுருக்கமான', 'விரிவான'], answer: 2, explanation: 'Verbose means using too many words; antonym is Concise (brief)', explanationTamil: 'Verbose என்றால் அதிக வார்த்தைகள் பயன்படுத்துவது; எதிர்ச்சொல் Concise (சுருக்கமான)', subject: 'English Language', difficulty: 'medium' },
      { id: 'sbi-po-eng-4', question: 'Fill in the blank: The manager insisted _____ seeing the documents.', questionTamil: 'வெற்றிடத்தை நிரப்புக: The manager insisted _____ seeing the documents.', options: ['on', 'in', 'at', 'for'], optionsTamil: ['on', 'in', 'at', 'for'], answer: 0, explanation: '"Insist on" is the correct phrasal verb', explanationTamil: '"Insist on" என்பது சரியான சொற்றொடர் வினைச்சொல்', subject: 'English Language', difficulty: 'easy' },
      { id: 'sbi-po-eng-5', question: 'The phrase "At the eleventh hour" means:', questionTamil: '"At the eleventh hour" என்ற சொற்றொடரின் பொருள்:', options: ['At 11 o\'clock', 'Very early', 'At the last moment', 'During lunch'], optionsTamil: ['11 மணிக்கு', 'மிக சீக்கிரம்', 'கடைசி நேரத்தில்', 'மதிய உணவின் போது'], answer: 2, explanation: '"At the eleventh hour" means at the last possible moment before a deadline', explanationTamil: '"At the eleventh hour" என்பது காலக்கெடுவுக்கு முன் கடைசி சாத்தியமான தருணத்தில் என்று பொருள்', subject: 'English Language', difficulty: 'easy' },
      // Data Analysis & Interpretation
      { id: 'sbi-po-di-1', question: 'If the total production is 5000 units and Product A is 20%, what is the production of A?', questionTamil: 'மொத்த உற்பத்தி 5000 யூனிட்கள் மற்றும் தயாரிப்பு A 20% எனில், A இன் உற்பத்தி என்ன?', options: ['1000 units', '800 units', '1200 units', '500 units'], optionsTamil: ['1000 யூனிட்கள்', '800 யூனிட்கள்', '1200 யூனிட்கள்', '500 யூனிட்கள்'], answer: 0, explanation: '20% of 5000 = 0.20 × 5000 = 1000 units', explanationTamil: '5000 இன் 20% = 0.20 × 5000 = 1000 யூனிட்கள்', subject: 'Data Analysis', difficulty: 'easy' },
      { id: 'sbi-po-di-2', question: 'The ratio of exports to imports is 3:5. If imports are ₹25 crores, what are exports?', questionTamil: 'ஏற்றுமதிக்கும் இறக்குமதிக்கும் உள்ள விகிதம் 3:5. இறக்குமதி ₹25 கோடி எனில், ஏற்றுமதி என்ன?', options: ['₹15 crores', '₹20 crores', '₹12 crores', '₹18 crores'], optionsTamil: ['₹15 கோடி', '₹20 கோடி', '₹12 கோடி', '₹18 கோடி'], answer: 0, explanation: 'If 5 parts = 25, then 1 part = 5. Exports = 3 parts = 15 crores', explanationTamil: '5 பகுதிகள் = 25 எனில், 1 பகுதி = 5. ஏற்றுமதி = 3 பகுதிகள் = 15 கோடி', subject: 'Data Analysis', difficulty: 'easy' },
      { id: 'sbi-po-di-3', question: 'A company\'s profit increased from ₹80 lakhs to ₹100 lakhs. What is the percentage increase?', questionTamil: 'ஒரு நிறுவனத்தின் லாபம் ₹80 லட்சத்திலிருந்து ₹100 லட்சமாக அதிகரித்தது. சதவீத அதிகரிப்பு என்ன?', options: ['20%', '25%', '30%', '15%'], optionsTamil: ['20%', '25%', '30%', '15%'], answer: 1, explanation: 'Increase = 20 lakhs. % increase = (20/80) × 100 = 25%', explanationTamil: 'அதிகரிப்பு = 20 லட்சம். % அதிகரிப்பு = (20/80) × 100 = 25%', subject: 'Data Analysis', difficulty: 'easy' },
      { id: 'sbi-po-di-4', question: 'In a pie chart, if sector A represents 72°, what percentage of total does it represent?', questionTamil: 'ஒரு வட்ட விளக்கப்படத்தில், துறை A 72° குறிக்கிறது எனில், அது மொத்தத்தில் எத்தனை சதவீதம்?', options: ['18%', '20%', '25%', '15%'], optionsTamil: ['18%', '20%', '25%', '15%'], answer: 1, explanation: 'Percentage = (72/360) × 100 = 20%', explanationTamil: 'சதவீதம் = (72/360) × 100 = 20%', subject: 'Data Analysis', difficulty: 'easy' },
      // Reasoning & Computer Aptitude
      { id: 'sbi-po-reason-1', question: 'In a row of 25 students, X is 12th from left. What is his position from right?', questionTamil: '25 மாணவர்கள் உள்ள வரிசையில், X இடமிருந்து 12வது. வலமிருந்து அவரது நிலை என்ன?', options: ['13th', '14th', '15th', '12th'], optionsTamil: ['13வது', '14வது', '15வது', '12வது'], answer: 1, explanation: 'Position from right = Total - Position from left + 1 = 25 - 12 + 1 = 14th', explanationTamil: 'வலமிருந்து நிலை = மொத்தம் - இடமிருந்து நிலை + 1 = 25 - 12 + 1 = 14வது', subject: 'Reasoning Ability', difficulty: 'easy' },
      { id: 'sbi-po-reason-2', question: 'If DEPOSIT is coded as ITHMTFE, then ACCOUNT is coded as:', questionTamil: 'DEPOSIT என்பது ITHMTFE என குறியீடு செய்யப்பட்டால், ACCOUNT என்பது எவ்வாறு குறியீடு செய்யப்படும்?', options: ['BDDPVOU', 'BDEPVOU', 'TPPVODD', 'UOVPDDB'], optionsTamil: ['BDDPVOU', 'BDEPVOU', 'TPPVODD', 'UOVPDDB'], answer: 3, explanation: 'Pattern: Reverse the word and add +1 to each letter. TNUOCCA → UOVPDDB', explanationTamil: 'அமைப்பு: சொல்லை மாற்றி ஒவ்வொரு எழுத்துக்கும் +1 சேர்க்கவும். TNUOCCA → UOVPDDB', subject: 'Reasoning Ability', difficulty: 'hard' },
      { id: 'sbi-po-reason-3', question: 'Statement: Some loans are debts. All debts are liabilities. Conclusions: I. Some loans are liabilities. II. All liabilities are debts.', questionTamil: 'கூற்று: சில கடன்கள் கடன்கள். அனைத்து கடன்களும் பொறுப்புகள். முடிவுகள்: I. சில கடன்கள் பொறுப்புகள். II. அனைத்து பொறுப்புகளும் கடன்கள்.', options: ['Only I follows', 'Only II follows', 'Both follow', 'Neither follows'], optionsTamil: ['I மட்டும் பின்தொடர்கிறது', 'II மட்டும் பின்தொடர்கிறது', 'இரண்டும் பின்தொடர்கின்றன', 'எதுவும் பின்தொடரவில்லை'], answer: 0, explanation: 'Some loans are debts, and all debts are liabilities, so some loans are liabilities (I follows). But not all liabilities are debts (II doesn\'t follow)', explanationTamil: 'சில கடன்கள் கடன்கள், மற்றும் அனைத்து கடன்களும் பொறுப்புகள், எனவே சில கடன்கள் பொறுப்புகள் (I பின்தொடர்கிறது). ஆனால் அனைத்து பொறுப்புகளும் கடன்கள் அல்ல (II பின்தொடரவில்லை)', subject: 'Reasoning Ability', difficulty: 'medium' },
      { id: 'sbi-po-comp-1', question: 'Which protocol is used for secure data transmission over internet?', questionTamil: 'இணையத்தில் பாதுகாப்பான தரவு பரிமாற்றத்திற்கு எந்த நெறிமுறை பயன்படுத்தப்படுகிறது?', options: ['HTTP', 'FTP', 'HTTPS', 'SMTP'], optionsTamil: ['HTTP', 'FTP', 'HTTPS', 'SMTP'], answer: 2, explanation: 'HTTPS (Hypertext Transfer Protocol Secure) provides secure communication over internet', explanationTamil: 'HTTPS (பாதுகாப்பான ஹைப்பர்டெக்ஸ்ட் பரிமாற்ற நெறிமுறை) இணையத்தில் பாதுகாப்பான தொடர்பை வழங்குகிறது', subject: 'Computer Aptitude', difficulty: 'easy' },
      { id: 'sbi-po-comp-2', question: 'RAM is a type of:', questionTamil: 'RAM ஒரு வகை:', options: ['Secondary memory', 'Primary memory', 'Cache memory', 'Virtual memory'], optionsTamil: ['இரண்டாம் நிலை நினைவகம்', 'முதன்மை நினைவகம்', 'தற்காலிக நினைவகம்', 'மெய்நிகர் நினைவகம்'], answer: 1, explanation: 'RAM (Random Access Memory) is primary/main memory, volatile in nature', explanationTamil: 'RAM (சீரற்ற அணுகல் நினைவகம்) முதன்மை/பிரதான நினைவகம், தன்மையில் ஆவியாகக்கூடியது', subject: 'Computer Aptitude', difficulty: 'easy' },
      // Banking Awareness
      { id: 'sbi-po-ba-1', question: 'What is reverse repo rate?', questionTamil: 'ரிவர்ஸ் ரெப்போ விகிதம் என்றால் என்ன?', options: ['Rate at which RBI borrows from banks', 'Rate at which RBI lends to banks', 'Interest rate on savings', 'Loan interest rate'], optionsTamil: ['RBI வங்கிகளிடமிருந்து கடன் பெறும் விகிதம்', 'RBI வங்கிகளுக்கு கடன் கொடுக்கும் விகிதம்', 'சேமிப்பு வட்டி விகிதம்', 'கடன் வட்டி விகிதம்'], answer: 0, explanation: 'Reverse repo rate is the rate at which RBI borrows money from commercial banks', explanationTamil: 'ரிவர்ஸ் ரெப்போ விகிதம் என்பது RBI வணிக வங்கிகளிடமிருந்து பணம் கடன் பெறும் விகிதம்', subject: 'Banking Awareness', difficulty: 'easy' },
      { id: 'sbi-po-ba-2', question: 'What is CRR?', questionTamil: 'CRR என்றால் என்ன?', options: ['Cash Reserve Ratio', 'Credit Reserve Ratio', 'Current Reserve Ratio', 'Capital Reserve Ratio'], optionsTamil: ['பண இருப்பு விகிதம்', 'கடன் இருப்பு விகிதம்', 'நடப்பு இருப்பு விகிதம்', 'மூலதன இருப்பு விகிதம்'], answer: 0, explanation: 'CRR = Cash Reserve Ratio, portion of deposits banks must keep with RBI', explanationTamil: 'CRR = பண இருப்பு விகிதம், வங்கிகள் RBI இடம் வைக்க வேண்டிய வைப்புகளின் பகுதி', subject: 'Banking Awareness', difficulty: 'easy' },
      { id: 'sbi-po-ba-3', question: 'SLR stands for:', questionTamil: 'SLR என்பதன் விரிவாக்கம்:', options: ['Standard Liquid Ratio', 'Statutory Liquidity Ratio', 'Savings Liquidity Ratio', 'Standard Liability Ratio'], optionsTamil: ['நிலையான திரவ விகிதம்', 'சட்டப்பூர்வ பணப்புழக்க விகிதம்', 'சேமிப்பு பணப்புழக்க விகிதம்', 'நிலையான பொறுப்பு விகிதம்'], answer: 1, explanation: 'SLR = Statutory Liquidity Ratio, minimum reserves banks must maintain', explanationTamil: 'SLR = சட்டப்பூர்வ பணப்புழக்க விகிதம், வங்கிகள் பராமரிக்க வேண்டிய குறைந்தபட்ச இருப்புக்கள்', subject: 'Banking Awareness', difficulty: 'easy' },
      { id: 'sbi-po-ba-4', question: 'What is the purpose of DICGC in banking?', questionTamil: 'வங்கியியலில் DICGC இன் நோக்கம் என்ன?', options: ['Regulating banks', 'Deposit insurance', 'Granting loans', 'Foreign exchange'], optionsTamil: ['வங்கிகளை ஒழுங்குபடுத்துதல்', 'வைப்பு காப்பீடு', 'கடன்கள் வழங்குதல்', 'அந்நிய செலாவணி'], answer: 1, explanation: 'DICGC (Deposit Insurance and Credit Guarantee Corporation) insures bank deposits up to ₹5 lakh', explanationTamil: 'DICGC (வைப்பு காப்பீடு மற்றும் கடன் உத்தரவாத நிறுவனம்) ₹5 லட்சம் வரை வங்கி வைப்புகளை காப்பீடு செய்கிறது', subject: 'Banking Awareness', difficulty: 'medium' },
      { id: 'sbi-po-ba-5', question: 'What is the tenure of RBI Governor?', questionTamil: 'RBI கவர்னரின் பதவிக்காலம் என்ன?', options: ['3 years', '4 years', '5 years', 'No fixed tenure'], optionsTamil: ['3 ஆண்டுகள்', '4 ஆண்டுகள்', '5 ஆண்டுகள்', 'நிலையான பதவிக்காலம் இல்லை'], answer: 3, explanation: 'RBI Governor has no fixed tenure; appointed by Central Government', explanationTamil: 'RBI கவர்னருக்கு நிலையான பதவிக்காலம் இல்லை; மத்திய அரசால் நியமிக்கப்படுகிறார்', subject: 'Banking Awareness', difficulty: 'medium' },
      { id: 'sbi-po-ba-6', question: 'NPA in banking stands for:', questionTamil: 'வங்கியியலில் NPA என்பதன் விரிவாக்கம்:', options: ['Non-Performing Asset', 'New Payment Account', 'National Payment Authority', 'Non-Profit Account'], optionsTamil: ['செயல்படாத சொத்து', 'புதிய கட்டண கணக்கு', 'தேசிய கட்டண ஆணையம்', 'இலாப நோக்கமற்ற கணக்கு'], answer: 0, explanation: 'NPA = Non-Performing Asset, loans where principal/interest is overdue for 90+ days', explanationTamil: 'NPA = செயல்படாத சொத்து, அசல்/வட்டி 90+ நாட்களுக்கு மேல் தாமதமான கடன்கள்', subject: 'Banking Awareness', difficulty: 'easy' }
    ]
  },
  {
    id: 'rbi-assistant',
    name: 'RBI Assistant',
    nameTamil: 'RBI உதவியாளர்',
    qualification: 'Any Graduate',
    qualificationTamil: 'ஏதேனும் பட்டதாரி',
    age: '20 - 28 years',
    salary: '₹36,091 - ₹65,500/month',
    selectionProcess: 'Prelims → Mains → Language Proficiency Test',
    selectionProcessTamil: 'முதநிலை → முதன்மை → மொழித் திறன் தேர்வு',
    posts: ['Assistant'],
    postsTamil: ['உதவியாளர்'],
    examPattern: [
      { paper: 'Prelims', paperTamil: 'முதநிலை', marks: 100, duration: '1 hour', questions: 100 },
      { paper: 'Mains', paperTamil: 'முதன்மை', marks: 200, duration: '2 hours 15 minutes', questions: 200 }
    ],
    syllabus: {
      main: [
        {
          name: 'RBI Assistant Syllabus',
          nameTamil: 'RBI உதவியாளர் பாடத்திட்டம்',
          topics: [
            { name: 'English Language', nameTamil: 'ஆங்கில மொழி', subtopics: ['Reading Comprehension', 'Cloze Test', 'Error Spotting', 'Para Jumbles', 'Vocabulary'] },
            { name: 'Numerical Ability', nameTamil: 'எண் திறன்', subtopics: ['Simplification', 'Number Series', 'Data Interpretation', 'Quadratic Equations', 'Arithmetic'] },
            { name: 'Reasoning Ability', nameTamil: 'தர்க்க திறன்', subtopics: ['Puzzles', 'Seating Arrangement', 'Syllogism', 'Blood Relations', 'Inequality'] },
            { name: 'General Awareness', nameTamil: 'பொது விழிப்புணர்வு', subtopics: ['Banking Awareness', 'Current Affairs', 'RBI Functions', 'Financial Awareness'] },
            { name: 'Computer Knowledge', nameTamil: 'கணினி அறிவு', subtopics: ['Computer Basics', 'MS Office', 'Internet', 'Networking', 'Cyber Security'] }
          ]
        }
      ]
    },
    pyq: [
      // English Language
      { id: 'rbi-eng-1', question: 'Choose the word most similar in meaning to "PRAGMATIC":', questionTamil: '"PRAGMATIC" என்பதற்கு மிகவும் ஒத்த பொருளுடைய சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Idealistic', 'Practical', 'Theoretical', 'Abstract'], optionsTamil: ['இலட்சியவாத', 'நடைமுறை', 'கோட்பாட்டு', 'சுருக்கமான'], answer: 1, explanation: 'Pragmatic means dealing with things sensibly and realistically; synonym is Practical', explanationTamil: 'Pragmatic என்றால் விஷயங்களை விவேகமாகவும் யதார்த்தமாகவும் கையாளுவது; ஒத்த சொல் Practical', subject: 'English Language', difficulty: 'medium' },
      { id: 'rbi-eng-2', question: 'The idiom "To bite the bullet" means:', questionTamil: '"To bite the bullet" என்ற மரபுத்தொடரின் பொருள்:', options: ['To eat quickly', 'To face a difficult situation', 'To be aggressive', 'To refuse something'], optionsTamil: ['வேகமாக சாப்பிட', 'கடினமான சூழ்நிலையை எதிர்கொள்ள', 'ஆக்ரோஷமாக இருக்க', 'ஏதாவது மறுக்க'], answer: 1, explanation: '"To bite the bullet" means to face a painful or difficult situation with courage', explanationTamil: '"To bite the bullet" என்பது வலிமிகுந்த அல்லது கடினமான சூழ்நிலையை தைரியமாக எதிர்கொள்வது', subject: 'English Language', difficulty: 'medium' },
      { id: 'rbi-eng-3', question: 'Choose the antonym of "OPAQUE":', questionTamil: '"OPAQUE" இன் எதிர்ச்சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Dark', 'Cloudy', 'Transparent', 'Thick'], optionsTamil: ['இருண்ட', 'மேகமூட்டமான', 'வெளிப்படையான', 'தடிமனான'], answer: 2, explanation: 'Opaque means not transparent; antonym is Transparent', explanationTamil: 'Opaque என்றால் வெளிப்படையாக இல்லாதது; எதிர்ச்சொல் Transparent', subject: 'English Language', difficulty: 'easy' },
      { id: 'rbi-eng-4', question: 'Fill in the blank: The RBI is _____ for monetary policy.', questionTamil: 'வெற்றிடத்தை நிரப்புக: The RBI is _____ for monetary policy.', options: ['responsible', 'irresponsible', 'neglectful', 'careless'], optionsTamil: ['பொறுப்பான', 'பொறுப்பற்ற', 'அலட்சியமான', 'கவனமற்ற'], answer: 0, explanation: 'RBI is responsible for monetary policy in India', explanationTamil: 'இந்தியாவில் பணவியல் கொள்கைக்கு RBI பொறுப்பு', subject: 'English Language', difficulty: 'easy' },
      { id: 'rbi-eng-5', question: 'Choose the correctly spelled word:', questionTamil: 'சரியாக எழுத்துப்பிழையின்றி எழுதப்பட்ட சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Accomodation', 'Accommodation', 'Acommodation', 'Acomodation'], optionsTamil: ['Accomodation', 'Accommodation', 'Acommodation', 'Acomodation'], answer: 1, explanation: 'Correct spelling is "Accommodation" with double c and double m', explanationTamil: '"Accommodation" இரட்டை c மற்றும் இரட்டை m உடன் சரியான எழுத்துப்பிழை', subject: 'English Language', difficulty: 'easy' },
      // Numerical Ability
      { id: 'rbi-num-1', question: 'What is the compound interest on ₹10,000 for 2 years at 8% per annum?', questionTamil: '₹10,000 க்கு 8% வருடாந்திர வட்டியில் 2 வருடங்களுக்கான கூட்டு வட்டி என்ன?', options: ['₹1,664', '₹1,600', '₹1,728', '₹1,500'], optionsTamil: ['₹1,664', '₹1,600', '₹1,728', '₹1,500'], answer: 0, explanation: 'CI = P[(1+r/100)^n - 1] = 10000[(1.08)² - 1] = 10000 × 0.1664 = ₹1,664', explanationTamil: 'CI = P[(1+r/100)^n - 1] = 10000[(1.08)² - 1] = 10000 × 0.1664 = ₹1,664', subject: 'Numerical Ability', difficulty: 'medium' },
      { id: 'rbi-num-2', question: 'Find the next term: 5, 11, 23, 47, 95, ?', questionTamil: 'அடுத்த எண்ணைக் கண்டறிக: 5, 11, 23, 47, 95, ?', options: ['189', '191', '193', '187'], optionsTamil: ['189', '191', '193', '187'], answer: 1, explanation: 'Pattern: ×2 + 1. 95 × 2 + 1 = 191', explanationTamil: 'முறை: ×2 + 1. 95 × 2 + 1 = 191', subject: 'Numerical Ability', difficulty: 'medium' },
      { id: 'rbi-num-3', question: 'A train 150m long passes a pole in 15 seconds. What is its speed in km/hr?', questionTamil: '150 மீ நீளமுள்ள ரயில் ஒரு கம்பத்தை 15 வினாடிகளில் கடக்கிறது. அதன் வேகம் கி.மீ/மணி யில் என்ன?', options: ['36 km/hr', '40 km/hr', '42 km/hr', '45 km/hr'], optionsTamil: ['36 கி.மீ/மணி', '40 கி.மீ/மணி', '42 கி.மீ/மணி', '45 கி.மீ/மணி'], answer: 0, explanation: 'Speed = 150/15 = 10 m/s = 10 × 18/5 = 36 km/hr', explanationTamil: 'வேகம் = 150/15 = 10 மீ/வி = 10 × 18/5 = 36 கி.மீ/மணி', subject: 'Numerical Ability', difficulty: 'easy' },
      { id: 'rbi-num-4', question: 'If 40% of a number is 80, what is the number?', questionTamil: 'ஒரு எண்ணின் 40% 80 எனில், அந்த எண் என்ன?', options: ['200', '180', '220', '160'], optionsTamil: ['200', '180', '220', '160'], answer: 0, explanation: '40% × x = 80. x = 80 × 100/40 = 200', explanationTamil: '40% × x = 80. x = 80 × 100/40 = 200', subject: 'Numerical Ability', difficulty: 'easy' },
      { id: 'rbi-num-5', question: 'The ratio of ages of A and B is 3:5. If B is 25 years old, how old is A?', questionTamil: 'A மற்றும் B இன் வயது விகிதம் 3:5. B 25 வயது எனில், A எத்தனை வயது?', options: ['15 years', '18 years', '20 years', '12 years'], optionsTamil: ['15 வருடம்', '18 வருடம்', '20 வருடம்', '12 வருடம்'], answer: 0, explanation: 'If 5 parts = 25, then 1 part = 5. A = 3 parts = 15 years', explanationTamil: '5 பகுதிகள் = 25 எனில், 1 பகுதி = 5. A = 3 பகுதிகள் = 15 வருடம்', subject: 'Numerical Ability', difficulty: 'easy' },
      // Reasoning Ability
      { id: 'rbi-reason-1', question: 'In a code, RESERVE is written as EVRESER. How is BANKING written?', questionTamil: 'ஒரு குறியீட்டில், RESERVE என்பது EVRESER என எழுதப்படுகிறது. BANKING எவ்வாறு எழுதப்படும்?', options: ['GNIKNAB', 'GNIKBAN', 'GNAKBIN', 'GNKNIAB'], optionsTamil: ['GNIKNAB', 'GNIKBAN', 'GNAKBIN', 'GNKNIAB'], answer: 0, explanation: 'Pattern: Word is reversed. BANKING → GNIKNAB', explanationTamil: 'முறை: சொல் மாற்றப்படுகிறது. BANKING → GNIKNAB', subject: 'Reasoning Ability', difficulty: 'easy' },
      { id: 'rbi-reason-2', question: 'Statement: All currencies are notes. Some notes are coins. Conclusions: I. Some currencies are coins. II. All notes are currencies.', questionTamil: 'கூற்று: அனைத்து நாணயங்களும் நோட்டுக்கள். சில நோட்டுக்கள் நாணயங்கள். முடிவுகள்: I. சில நாணயங்கள் காயின்கள். II. அனைத்து நோட்டுக்களும் நாணயங்கள்.', options: ['Only I follows', 'Only II follows', 'Both follow', 'Neither follows'], optionsTamil: ['I மட்டும் பின்தொடர்கிறது', 'II மட்டும் பின்தொடர்கிறது', 'இரண்டும் பின்தொடர்கின்றன', 'எதுவும் பின்தொடரவில்லை'], answer: 3, explanation: 'Neither follows. All currencies are notes, but only some notes are coins - no direct link to currencies being coins. And not all notes are currencies.', explanationTamil: 'எதுவும் பின்தொடரவில்லை. அனைத்து நாணயங்களும் நோட்டுக்கள், ஆனால் சில நோட்டுக்கள் மட்டுமே காயின்கள்.', subject: 'Reasoning Ability', difficulty: 'hard' },
      { id: 'rbi-reason-3', question: 'Five friends A, B, C, D, E are sitting in a row. A is at the right of B. C is at the left of D. E is at the right of C. Who is in the middle?', questionTamil: 'ஐந்து நண்பர்கள் A, B, C, D, E ஒரு வரிசையில் அமர்ந்துள்ளனர். A என்பவர் B இன் வலப்புறம். C என்பவர் D இன் இடப்புறம். E என்பவர் C இன் வலப்புறம். நடுவில் யார்?', options: ['A', 'B', 'C', 'E'], optionsTamil: ['A', 'B', 'C', 'E'], answer: 2, explanation: 'Arrangement: B-A, C-D, C-E. Possible: B-A-C-E-D, C is middle', explanationTamil: 'அமைப்பு: B-A, C-D, C-E. சாத்தியம்: B-A-C-E-D, C நடுவில்', subject: 'Reasoning Ability', difficulty: 'medium' },
      // General Awareness - RBI Specific
      { id: 'rbi-ga-1', question: 'RBI was established under which Act?', questionTamil: 'RBI எந்த சட்டத்தின் கீழ் நிறுவப்பட்டது?', options: ['Banking Regulation Act 1949', 'RBI Act 1934', 'Companies Act 1956', 'FEMA 1999'], optionsTamil: ['வங்கி ஒழுங்குமுறை சட்டம் 1949', 'RBI சட்டம் 1934', 'நிறுவனங்கள் சட்டம் 1956', 'FEMA 1999'], answer: 1, explanation: 'RBI was established under the Reserve Bank of India Act, 1934', explanationTamil: 'RBI இந்திய ரிசர்வ் வங்கி சட்டம் 1934 இன் கீழ் நிறுவப்பட்டது', subject: 'General Awareness', difficulty: 'easy' },
      { id: 'rbi-ga-2', question: 'Who was the first Indian Governor of RBI?', questionTamil: 'RBI இன் முதல் இந்திய கவர்னர் யார்?', options: ['C.D. Deshmukh', 'Sir Osborne Smith', 'James Taylor', 'H.J. Khandelwal'], optionsTamil: ['சி.டி. தேஷ்முக்', 'சர் ஓஸ்போர்ன் ஸ்மித்', 'ஜேம்ஸ் டெய்லர்', 'எச்.ஜே. கண்டேல்வால்'], answer: 0, explanation: 'C.D. Deshmukh was the first Indian Governor of RBI (1943-1949)', explanationTamil: 'சி.டி. தேஷ்முக் RBI இன் முதல் இந்திய கவர்னர் (1943-1949)', subject: 'General Awareness', difficulty: 'medium' },
      { id: 'rbi-ga-3', question: 'RBI headquarters is located in:', questionTamil: 'RBI தலைமையகம் எங்கு அமைந்துள்ளது?', options: ['New Delhi', 'Mumbai', 'Kolkata', 'Chennai'], optionsTamil: ['புது டெல்லி', 'மும்பை', 'கொல்கத்தா', 'சென்னை'], answer: 1, explanation: 'RBI headquarters is in Mumbai (Shahid Bhagat Singh Marg)', explanationTamil: 'RBI தலைமையகம் மும்பையில் உள்ளது (ஷஹீத் பகத் சிங் மார்க்)', subject: 'General Awareness', difficulty: 'easy' },
      { id: 'rbi-ga-4', question: 'Which committee recommended inflation targeting in India?', questionTamil: 'இந்தியாவில் பணவீக்க இலக்கை பரிந்துரைத்த குழு எது?', options: ['Narasimham Committee', 'Urjit Patel Committee', 'Tarapore Committee', 'Kelkar Committee'], optionsTamil: ['நரசிம்மம் குழு', 'உர்ஜித் படேல் குழு', 'தாராபூர் குழு', 'கேல்கர் குழு'], answer: 1, explanation: 'Urjit Patel Committee (2014) recommended inflation targeting framework', explanationTamil: 'உர்ஜித் படேல் குழு (2014) பணவீக்க இலக்கு கட்டமைப்பை பரிந்துரைத்தது', subject: 'General Awareness', difficulty: 'hard' },
      { id: 'rbi-ga-5', question: 'RBI issues currency notes except:', questionTamil: 'RBI எந்த நோட்டைத் தவிர அனைத்து நாணய நோட்டுகளையும் வெளியிடுகிறது?', options: ['₹100 note', '₹500 note', '₹1 note', '₹2000 note'], optionsTamil: ['₹100 நோட்டு', '₹500 நோட்டு', '₹1 நோட்டு', '₹2000 நோட்டு'], answer: 2, explanation: '₹1 note is issued by Ministry of Finance, not RBI', explanationTamil: '₹1 நோட்டு நிதி அமைச்சகத்தால் வெளியிடப்படுகிறது, RBI அல்ல', subject: 'General Awareness', difficulty: 'medium' },
      // Computer Knowledge
      { id: 'rbi-comp-1', question: 'Which shortcut is used to copy selected text?', questionTamil: 'தேர்ந்தெடுக்கப்பட்ட உரையை நகலெடுக்க எந்த குறுக்குவழி பயன்படுத்தப்படுகிறது?', options: ['Ctrl+X', 'Ctrl+C', 'Ctrl+V', 'Ctrl+A'], optionsTamil: ['Ctrl+X', 'Ctrl+C', 'Ctrl+V', 'Ctrl+A'], answer: 1, explanation: 'Ctrl+C is used to copy selected text or content', explanationTamil: 'தேர்ந்தெடுக்கப்பட்ட உரை அல்லது உள்ளடக்கத்தை நகலெடுக்க Ctrl+C பயன்படுத்தப்படுகிறது', subject: 'Computer Knowledge', difficulty: 'easy' },
      { id: 'rbi-comp-2', question: 'RAM stands for:', questionTamil: 'RAM என்பதன் விரிவாக்கம்:', options: ['Read Access Memory', 'Random Access Memory', 'Run Access Memory', 'Real Access Memory'], optionsTamil: ['Read Access Memory', 'Random Access Memory', 'Run Access Memory', 'Real Access Memory'], answer: 1, explanation: 'RAM = Random Access Memory, primary volatile memory', explanationTamil: 'RAM = Random Access Memory, முதன்மை ஆவியாகக்கூடிய நினைவகம்', subject: 'Computer Knowledge', difficulty: 'easy' },
      { id: 'rbi-comp-3', question: 'Which is NOT an input device?', questionTamil: 'எது உள்ளீட்டு சாதனம் அல்ல?', options: ['Keyboard', 'Mouse', 'Monitor', 'Scanner'], optionsTamil: ['கீபோர்டு', 'மவுஸ்', 'மானிட்டர்', 'ஸ்கேனர்'], answer: 2, explanation: 'Monitor is an output device, not input device', explanationTamil: 'மானிட்டர் ஒரு வெளியீட்டு சாதனம், உள்ளீட்டு சாதனம் அல்ல', subject: 'Computer Knowledge', difficulty: 'easy' },
      { id: 'rbi-comp-4', question: 'What is the full form of PDF?', questionTamil: 'PDF இன் முழு வடிவம் என்ன?', options: ['Portable Document Format', 'Print Document Format', 'Personal Data File', 'Protected Document Format'], optionsTamil: ['Portable Document Format', 'Print Document Format', 'Personal Data File', 'Protected Document Format'], answer: 0, explanation: 'PDF = Portable Document Format, developed by Adobe', explanationTamil: 'PDF = Portable Document Format, Adobe ஆல் உருவாக்கப்பட்டது', subject: 'Computer Knowledge', difficulty: 'easy' },
      { id: 'rbi-comp-5', question: 'Which protocol is used for email sending?', questionTamil: 'மின்னஞ்சல் அனுப்ப எந்த நெறிமுறை பயன்படுத்தப்படுகிறது?', options: ['HTTP', 'FTP', 'SMTP', 'TCP'], optionsTamil: ['HTTP', 'FTP', 'SMTP', 'TCP'], answer: 2, explanation: 'SMTP (Simple Mail Transfer Protocol) is used for sending emails', explanationTamil: 'SMTP (எளிய அஞ்சல் பரிமாற்ற நெறிமுறை) மின்னஞ்சல் அனுப்ப பயன்படுத்தப்படுகிறது', subject: 'Computer Knowledge', difficulty: 'medium' }
    ]
  },
  {
    id: 'nabard',
    name: 'NABARD (Development Assistant/Grade A)',
    nameTamil: 'NABARD (வளர்ச்சி உதவியாளர்/தரம் A)',
    qualification: 'Any Graduate / Post Graduate',
    qualificationTamil: 'ஏதேனும் பட்டதாரி / முதுகலை பட்டதாரி',
    age: '21 - 30 years',
    salary: '₹28,000 - ₹45,000/month (Dev Asst) / ₹44,500+ (Grade A)',
    selectionProcess: 'Prelims → Mains → Interview',
    selectionProcessTamil: 'முதநிலை → முதன்மை → நேர்காணல்',
    posts: ['Development Assistant', 'Grade A Officer'],
    postsTamil: ['வளர்ச்சி உதவியாளர்', 'தரம் A அதிகாரி'],
    examPattern: [
      { paper: 'Prelims', paperTamil: 'முதநிலை', marks: 200, duration: '2 hours', questions: 200 },
      { paper: 'Mains', paperTamil: 'முதன்மை', marks: 200, duration: '2 hours', questions: 200 }
    ],
    syllabus: {
      main: [
        {
          name: 'NABARD Syllabus',
          nameTamil: 'NABARD பாடத்திட்டம்',
          topics: [
            { name: 'English Language', nameTamil: 'ஆங்கில மொழி', subtopics: ['Reading Comprehension', 'Cloze Test', 'Error Spotting', 'Para Jumbles'] },
            { name: 'Quantitative Aptitude', nameTamil: 'அளவு திறன்', subtopics: ['Simplification', 'Number Series', 'Data Interpretation', 'Quadratic Equations'] },
            { name: 'Reasoning Ability', nameTamil: 'தர்க்க திறன்', subtopics: ['Puzzles', 'Seating Arrangement', 'Syllogism', 'Coding-Decoding'] },
            { name: 'General Awareness', nameTamil: 'பொது விழிப்புணர்வு', subtopics: ['Agriculture', 'Rural Development', 'Banking', 'Current Affairs'] },
            { name: 'Computer Knowledge', nameTamil: 'கணினி அறிவு', subtopics: ['Computer Basics', 'MS Office', 'Internet', 'Database'] },
            { name: 'Agriculture & Rural Development', nameTamil: 'விவசாயம் & கிராம வளர்ச்சி', subtopics: ['Agriculture Schemes', 'Rural Credit', 'Cooperative Banking', 'Microfinance'] }
          ]
        }
      ]
    },
    pyq: [
      // English Language
      { id: 'nabard-eng-1', question: 'Choose the synonym of "AGRARIAN":', questionTamil: '"AGRARIAN" இன் ஒத்த சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Industrial', 'Agricultural', 'Urban', 'Commercial'], optionsTamil: ['தொழில்துறை', 'விவசாய', 'நகர்ப்புற', 'வணிக'], answer: 1, explanation: 'Agrarian means relating to cultivated land or agriculture; synonym is Agricultural', explanationTamil: 'Agrarian என்றால் பயிரிடப்பட்ட நிலம் அல்லது விவசாயம் தொடர்பானது; ஒத்த சொல் Agricultural', subject: 'English Language', difficulty: 'easy' },
      { id: 'nabard-eng-2', question: 'The phrase "To nip in the bud" means:', questionTamil: '"To nip in the bud" என்ற சொற்றொடரின் பொருள்:', options: ['To encourage growth', 'To stop early', 'To plant seeds', 'To water plants'], optionsTamil: ['வளர்ச்சியை ஊக்குவிக்க', 'ஆரம்பத்திலேயே நிறுத்த', 'விதைகளை நட', 'செடிகளுக்கு தண்ணீர் ஊற்ற'], answer: 1, explanation: '"To nip in the bud" means to stop something at an early stage', explanationTamil: '"To nip in the bud" என்பது ஒன்றை ஆரம்ப கட்டத்திலேயே நிறுத்துவது', subject: 'English Language', difficulty: 'medium' },
      { id: 'nabard-eng-3', question: 'Choose the antonym of "SURPLUS":', questionTamil: '"SURPLUS" இன் எதிர்ச்சொல்லைத் தேர்ந்தெடுக்கவும்:', options: ['Excess', 'Abundance', 'Deficit', 'Plenty'], optionsTamil: ['அதிகப்படி', 'மிகுதி', 'பற்றாக்குறை', 'ஏராளம்'], answer: 2, explanation: 'Surplus means excess or extra; antonym is Deficit (shortage)', explanationTamil: 'Surplus என்றால் அதிகப்படி அல்லது கூடுதல்; எதிர்ச்சொல் Deficit (பற்றாக்குறை)', subject: 'English Language', difficulty: 'easy' },
      { id: 'nabard-eng-4', question: 'Fill in the blank: The farmer _____ his crops before the monsoon.', questionTamil: 'வெற்றிடத்தை நிரப்புக: The farmer _____ his crops before the monsoon.', options: ['harvests', 'harvest', 'harvested', 'harvesting'], optionsTamil: ['harvests', 'harvest', 'harvested', 'harvesting'], answer: 0, explanation: 'Simple present tense with singular subject "farmer" takes "harvests"', explanationTamil: 'ஒருமை எழுவாய் "farmer" உடன் எளிய நிகழ்கால "harvests" எடுக்கும்', subject: 'English Language', difficulty: 'easy' },
      { id: 'nabard-eng-5', question: 'Identify the error: "The cattle is grazing (a) / in the field (b) / near the river. (c) / No error (d)"', questionTamil: 'பிழையை அடையாளம் காணவும்: "The cattle is grazing (a) / in the field (b) / near the river. (c) / No error (d)"', options: ['a', 'b', 'c', 'd'], answer: 0, explanation: 'Cattle is plural, so use "are grazing" instead of "is grazing"', explanationTamil: 'Cattle பன்மை, எனவே "is grazing" க்கு பதிலாக "are grazing" பயன்படுத்தவும்', subject: 'English Language', difficulty: 'medium' },
      // Quantitative Aptitude
      { id: 'nabard-quant-1', question: 'A farmer sells wheat at ₹25/kg. If he sells 400 kg, what is his total earning?', questionTamil: 'ஒரு விவசாயி கோதுமையை ₹25/கிலோ விற்கிறார். அவர் 400 கிலோ விற்றால், அவரது மொத்த வருமானம் என்ன?', options: ['₹10,000', '₹8,000', '₹12,000', '₹9,000'], optionsTamil: ['₹10,000', '₹8,000', '₹12,000', '₹9,000'], answer: 0, explanation: 'Total = 25 × 400 = ₹10,000', explanationTamil: 'மொத்தம் = 25 × 400 = ₹10,000', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      { id: 'nabard-quant-2', question: 'Find the next term: 2, 6, 18, 54, ?', questionTamil: 'அடுத்த எண்ணைக் கண்டறிக: 2, 6, 18, 54, ?', options: ['108', '162', '216', '150'], optionsTamil: ['108', '162', '216', '150'], answer: 1, explanation: 'Pattern: ×3. 54 × 3 = 162', explanationTamil: 'முறை: ×3. 54 × 3 = 162', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      { id: 'nabard-quant-3', question: 'A loan of ₹50,000 at 10% SI for 3 years. Total interest?', questionTamil: '₹50,000 கடன் 10% எளிய வட்டியில் 3 வருடங்களுக்கு. மொத்த வட்டி?', options: ['₹15,000', '₹12,000', '₹18,000', '₹10,000'], optionsTamil: ['₹15,000', '₹12,000', '₹18,000', '₹10,000'], answer: 0, explanation: 'SI = PRT/100 = 50000 × 10 × 3 / 100 = ₹15,000', explanationTamil: 'SI = PRT/100 = 50000 × 10 × 3 / 100 = ₹15,000', subject: 'Quantitative Aptitude', difficulty: 'easy' },
      { id: 'nabard-quant-4', question: 'If 20 farmers can harvest a field in 5 days, how many days for 25 farmers?', questionTamil: '20 விவசாயிகள் ஒரு வயலை 5 நாட்களில் அறுவடை செய்தால், 25 விவசாயிகளுக்கு எத்தனை நாட்கள்?', options: ['4 days', '6 days', '3 days', '5 days'], optionsTamil: ['4 நாட்கள்', '6 நாட்கள்', '3 நாட்கள்', '5 நாட்கள்'], answer: 0, explanation: 'Work = 20 × 5 = 100 man-days. Days = 100/25 = 4 days', explanationTamil: 'வேலை = 20 × 5 = 100 மனித-நாட்கள். நாட்கள் = 100/25 = 4 நாட்கள்', subject: 'Quantitative Aptitude', difficulty: 'medium' },
      { id: 'nabard-quant-5', question: 'A field is 120m long and 80m wide. What is its area in hectares?', questionTamil: 'ஒரு வயல் 120 மீ நீளமும் 80 மீ அகலமும் உடையது. அதன் பரப்பளவு ஹெக்டேரில் என்ன?', options: ['0.96 hectares', '9.6 hectares', '0.096 hectares', '96 hectares'], optionsTamil: ['0.96 ஹெக்டேர்', '9.6 ஹெக்டேர்', '0.096 ஹெக்டேர்', '96 ஹெக்டேர்'], answer: 0, explanation: 'Area = 120 × 80 = 9600 sq.m = 0.96 hectares (1 hectare = 10000 sq.m)', explanationTamil: 'பரப்பளவு = 120 × 80 = 9600 சதுர மீ = 0.96 ஹெக்டேர் (1 ஹெக்டேர் = 10000 சதுர மீ)', subject: 'Quantitative Aptitude', difficulty: 'medium' },
      // Reasoning Ability
      { id: 'nabard-reason-1', question: 'In a code, CROPS is written as ETQRU. How is YIELD written?', questionTamil: 'ஒரு குறியீட்டில், CROPS என்பது ETQRU என எழுதப்படுகிறது. YIELD எவ்வாறு எழுதப்படும்?', options: ['AGKNF', 'AGLNG', 'AGKNF', 'ZGDKC'], optionsTamil: ['AGKNF', 'AGLNG', 'AGKNF', 'ZGDKC'], answer: 0, explanation: 'Pattern: +2 to each letter. YIELD → AGKNF (Y+2=A, I+2=K, E+2=G, L+2=N, D+2=F)', explanationTamil: 'முறை: ஒவ்வொரு எழுத்துக்கும் +2. YIELD → AGKNF', subject: 'Reasoning Ability', difficulty: 'medium' },
      { id: 'nabard-reason-2', question: 'Statement: All seeds are plants. All plants need water. Conclusions: I. All seeds need water. II. Some plants are seeds.', questionTamil: 'கூற்று: அனைத்து விதைகளும் செடிகள். அனைத்து செடிகளுக்கும் தண்ணீர் தேவை. முடிவுகள்: I. அனைத்து விதைகளுக்கும் தண்ணீர் தேவை. II. சில செடிகள் விதைகள்.', options: ['Only I follows', 'Only II follows', 'Both follow', 'Neither follows'], optionsTamil: ['I மட்டும் பின்தொடர்கிறது', 'II மட்டும் பின்தொடர்கிறது', 'இரண்டும் பின்தொடர்கின்றன', 'எதுவும் பின்தொடரவில்லை'], answer: 2, explanation: 'Both conclusions follow from the given statements', explanationTamil: 'கொடுக்கப்பட்ட கூற்றுகளிலிருந்து இரண்டு முடிவுகளும் பின்தொடர்கின்றன', subject: 'Reasoning Ability', difficulty: 'medium' },
      { id: 'nabard-reason-3', question: 'Five villages A, B, C, D, E are in a line. B is between A and C. D is at the right end. E is not at either end. Which is in the middle?', questionTamil: 'ஐந்து கிராமங்கள் A, B, C, D, E ஒரு வரிசையில் உள்ளன. B என்பது A மற்றும் C இடையே. D வலது முனையில். E எந்த முனையிலும் இல்லை. நடுவில் எது?', options: ['A', 'B', 'C', 'E'], optionsTamil: ['A', 'B', 'C', 'E'], answer: 2, explanation: 'Arrangement: A-B-C-E-D. C is in the middle', explanationTamil: 'அமைப்பு: A-B-C-E-D. C நடுவில் உள்ளது', subject: 'Reasoning Ability', difficulty: 'medium' },
      // Agriculture & Rural Development - NABARD Specific
      { id: 'nabard-agri-1', question: 'NABARD was established in which year?', questionTamil: 'NABARD எந்த ஆண்டில் நிறுவப்பட்டது?', options: ['1980', '1982', '1985', '1975'], optionsTamil: ['1980', '1982', '1985', '1975'], answer: 1, explanation: 'NABARD was established on 12 July 1982', explanationTamil: 'NABARD 12 ஜூலை 1982 அன்று நிறுவப்பட்டது', subject: 'Agriculture & Rural Development', difficulty: 'easy' },
      { id: 'nabard-agri-2', question: 'NABARD full form is:', questionTamil: 'NABARD இன் முழு வடிவம்:', options: ['National Bank for Agriculture and Rural Development', 'National Board for Agriculture and Rural Development', 'New Bank for Agriculture and Rural Development', 'National Bureau for Agriculture and Rural Development'], optionsTamil: ['தேசிய விவசாய மற்றும் கிராம வளர்ச்சி வங்கி', 'தேசிய விவசாய மற்றும் கிராம வளர்ச்சி வாரியம்', 'புதிய விவசாய மற்றும் கிராம வளர்ச்சி வங்கி', 'தேசிய விவசாய மற்றும் கிராம வளர்ச்சி பணியகம்'], answer: 0, explanation: 'NABARD = National Bank for Agriculture and Rural Development', explanationTamil: 'NABARD = தேசிய விவசாய மற்றும் கிராம வளர்ச்சி வங்கி', subject: 'Agriculture & Rural Development', difficulty: 'easy' },
      { id: 'nabard-agri-3', question: 'Which scheme provides crop insurance to farmers?', questionTamil: 'எந்த திட்டம் விவசாயிகளுக்கு பயிர் காப்பீடு வழங்குகிறது?', options: ['PM-KISAN', 'PMFBY', 'PM-JAY', 'PM-SVANidhi'], optionsTamil: ['PM-KISAN', 'PMFBY', 'PM-JAY', 'PM-SVANidhi'], answer: 1, explanation: 'PMFBY = Pradhan Mantri Fasal Bima Yojana provides crop insurance', explanationTamil: 'PMFBY = பிரதான் மந்திரி ஃபசல் பீமா யோஜனா பயிர் காப்பீடு வழங்குகிறது', subject: 'Agriculture & Rural Development', difficulty: 'easy' },
      { id: 'nabard-agri-4', question: 'Kisan Credit Card (KCC) was introduced in which year?', questionTamil: 'கிசான் கிரெடிட் கார்டு (KCC) எந்த ஆண்டில் அறிமுகப்படுத்தப்பட்டது?', options: ['1996', '1998', '2000', '2002'], optionsTamil: ['1996', '1998', '2000', '2002'], answer: 1, explanation: 'Kisan Credit Card scheme was introduced in 1998', explanationTamil: 'கிசான் கிரெடிட் கார்டு திட்டம் 1998 இல் அறிமுகப்படுத்தப்பட்டது', subject: 'Agriculture & Rural Development', difficulty: 'medium' },
      { id: 'nabard-agri-5', question: 'PM-KISAN provides how much amount per year to farmers?', questionTamil: 'PM-KISAN விவசாயிகளுக்கு ஆண்டுக்கு எவ்வளவு தொகை வழங்குகிறது?', options: ['₹4,000', '₹6,000', '₹8,000', '₹10,000'], optionsTamil: ['₹4,000', '₹6,000', '₹8,000', '₹10,000'], answer: 1, explanation: 'PM-KISAN provides ₹6,000 per year (₹2,000 in 3 instalments)', explanationTamil: 'PM-KISAN ஆண்டுக்கு ₹6,000 வழங்குகிறது (3 தவணைகளில் ₹2,000)', subject: 'Agriculture & Rural Development', difficulty: 'easy' },
      { id: 'nabard-agri-6', question: 'NABARD headquarters is located in:', questionTamil: 'NABARD தலைமையகம் எங்கு அமைந்துள்ளது?', options: ['New Delhi', 'Mumbai', 'Kolkata', 'Hyderabad'], optionsTamil: ['புது டெல்லி', 'மும்பை', 'கொல்கத்தா', 'ஹைதராபாத்'], answer: 1, explanation: 'NABARD headquarters is in Mumbai', explanationTamil: 'NABARD தலைமையகம் மும்பையில் உள்ளது', subject: 'Agriculture & Rural Development', difficulty: 'easy' },
      { id: 'nabard-agri-7', question: 'Which organization regulates Regional Rural Banks (RRBs)?', questionTamil: 'மண்டல கிராம வங்கிகளை (RRBs) கட்டுப்படுத்தும் அமைப்பு எது?', options: ['SEBI', 'NABARD', 'IRDA', 'PFRDA'], optionsTamil: ['SEBI', 'NABARD', 'IRDA', 'PFRDA'], answer: 1, explanation: 'NABARD regulates and supervises Regional Rural Banks', explanationTamil: 'NABARD மண்டல கிராம வங்கிகளை கட்டுப்படுத்தி மேற்பார்வையிடுகிறது', subject: 'Agriculture & Rural Development', difficulty: 'medium' },
      { id: 'nabard-agri-8', question: 'Self Help Groups (SHGs) are linked to banks under which program?', questionTamil: 'சுய உதவி குழுக்கள் (SHGs) எந்த திட்டத்தின் கீழ் வங்கிகளுடன் இணைக்கப்படுகின்றன?', options: ['MUDRA', 'SHG-Bank Linkage Program', 'Stand-Up India', 'PM-SVANidhi'], optionsTamil: ['MUDRA', 'SHG-வங்கி இணைப்பு திட்டம்', 'Stand-Up India', 'PM-SVANidhi'], answer: 1, explanation: 'SHG-Bank Linkage Program connects SHGs to formal banking system', explanationTamil: 'SHG-வங்கி இணைப்பு திட்டம் SHG களை முறையான வங்கி அமைப்புடன் இணைக்கிறது', subject: 'Agriculture & Rural Development', difficulty: 'medium' },
      // Computer Knowledge
      { id: 'nabard-comp-1', question: 'MS Excel is used for:', questionTamil: 'MS Excel எதற்கு பயன்படுத்தப்படுகிறது:', options: ['Word Processing', 'Spreadsheet', 'Presentation', 'Database'], optionsTamil: ['சொல் செயலாக்கம்', 'விரிதாள்', 'விளக்கக்காட்சி', 'தரவுத்தளம்'], answer: 1, explanation: 'MS Excel is a spreadsheet application for data analysis and calculations', explanationTamil: 'MS Excel என்பது தரவு பகுப்பாய்வு மற்றும் கணக்கீடுகளுக்கான விரிதாள் பயன்பாடு', subject: 'Computer Knowledge', difficulty: 'easy' },
      { id: 'nabard-comp-2', question: 'Which is NOT an operating system?', questionTamil: 'எது இயக்க முறைமை அல்ல?', options: ['Windows', 'Linux', 'MS Word', 'macOS'], optionsTamil: ['Windows', 'Linux', 'MS Word', 'macOS'], answer: 2, explanation: 'MS Word is a word processing application, not an OS', explanationTamil: 'MS Word ஒரு சொல் செயலாக்க பயன்பாடு, இயக்க முறைமை அல்ல', subject: 'Computer Knowledge', difficulty: 'easy' },
      { id: 'nabard-comp-3', question: 'IP address full form is:', questionTamil: 'IP address முழு வடிவம்:', options: ['Internet Protocol', 'Internal Protocol', 'Integrated Protocol', 'International Protocol'], optionsTamil: ['Internet Protocol', 'Internal Protocol', 'Integrated Protocol', 'International Protocol'], answer: 0, explanation: 'IP = Internet Protocol address', explanationTamil: 'IP = Internet Protocol address', subject: 'Computer Knowledge', difficulty: 'easy' }
    ]
  },
  {
    id: 'india-post-gds',
