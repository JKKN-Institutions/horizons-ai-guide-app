  ...
  Physics: [
    {
      section: 'Mechanics',
      topics: [
        { name: 'Units & Measurement', total: 3, avg: 3, weightage: 6.67, trend: 11.17 },
        { name: 'Motion in a Straight Line', total: 2, avg: 2, weightage: 4.44, trend: 122 },
        { name: 'Motion in a Plane', total: 0, avg: 0, weightage: 0, trend: -100 },
        { name: 'Laws of Motion', total: 1, avg: 1, weightage: 2.22, trend: -26 },
        { name: 'Work, Energy and Power', total: 2, avg: 2, weightage: 4.44, trend: 48 },
        { name: 'Center of Mass and Collision', total: 1, avg: 1, weightage: 2.22, trend: 122 },
        { name: 'Rotational Motion', total: 3, avg: 3, weightage: 6.67, trend: 66.75 },
        { name: 'Gravitation', total: 2, avg: 2, weightage: 4.44, trend: 11 },
        { name: 'Properties of Matter', total: 1, avg: 1, weightage: 2.22, trend: -44.5 },
        { name: 'Heat and Thermodynamics', total: 4, avg: 4, weightage: 8.89, trend: 77.8 },
        { name: 'Oscillations', total: 2, avg: 2, weightage: 4.44, trend: 11 },
        { name: 'Waves', total: 1, avg: 1, weightage: 2.22, trend: 122, syllabusTag: 'Syllabus Reduced' },
      ],
    },
    {
      section: 'Electricity',
      topics: [
        { name: 'Electrostatics', total: 2, avg: 2, weightage: 4.44, trend: 11 },
        { name: 'Current Electricity', total: 3, avg: 3, weightage: 6.67, trend: -4.71 },
        { name: 'Capacitor', total: 1, avg: 1, weightage: 2.22, trend: -55.6 },
        { name: 'Moving Charges and Magnetism', total: 4, avg: 4, weightage: 8.89, trend: 344.5 },
        { name: 'Magnetism and Matter', total: 0, avg: 0, weightage: 0, trend: -100 },
        { name: 'Electromagnetic Induction', total: 1, avg: 1, weightage: 2.22, trend: 122 },
        { name: 'Alternating Current', total: 1, avg: 1, weightage: 2.22, trend: -55.6 },
        { name: 'Electromagnetic Waves', total: 1, avg: 1, weightage: 2.22, trend: -26 },
      ],
    },
    {
      section: 'Optics',
      topics: [
        { name: 'Geometrical Optics', total: 2, avg: 2, weightage: 4.44, trend: 48 },
        { name: 'Wave Optics', total: 2, avg: 2, weightage: 4.44, trend: -11.2 },
      ],
    },
    {
      section: 'Modern Physics',
      topics: [
        { name: 'Atoms and Nuclei', total: 1, avg: 1, weightage: 2.22, trend: -68.29, syllabusTag: 'Syllabus Reduced' },
        { name: 'Dual Nature of Radiation and Matter', total: 3, avg: 3, weightage: 6.67, trend: 66.75, syllabusTag: 'Syllabus Reduced' },
        { name: 'Semiconductor Electronics', total: 2, avg: 2, weightage: 4.44, trend: -26, syllabusTag: 'Syllabus Reduced' },
      ],
    },
  ],
  Chemistry: [
