...
const questionPapers: QuestionPaper[] = [
  { id: 1, exam: 'JEE Main', year: 2026, session: 'January Session 1 - Shift 1', subjects: ['Physics', 'Chemistry', 'Mathematics'], downloads: 24580, rating: 4.9, category: 'engineering', subcategory: 'jee-main', isNew: true, difficulty: 'Moderate', questions: 90, duration: '3 hrs', language: ['English', 'Hindi', 'Tamil'], trending: true },
  { id: 2, exam: 'JEE Main', year: 2026, session: 'January Session 1 - Shift 2', subjects: ['Physics', 'Chemistry', 'Mathematics'], downloads: 21300, rating: 4.8, category: 'engineering', subcategory: 'jee-main', isNew: true, difficulty: 'Hard', questions: 90, duration: '3 hrs', language: ['English', 'Hindi'] },
  ...
  { id: 8, exam: 'NEET UG', year: 2026, session: 'May Session', subjects: ['Physics', 'Chemistry', 'Biology'], downloads: 38500, rating: 4.9, category: 'medical', subcategory: 'neet-ug', isNew: true, difficulty: 'Hard', questions: 200, duration: '3 hrs 20 min', language: ['English', 'Hindi', 'Tamil'], trending: true },
  ...
  { id: 18, exam: 'CLAT', year: 2026, session: 'UG Exam', subjects: ['English', 'Legal Reasoning', 'GK', 'Quantitative', 'Logical'], downloads: 12540, rating: 4.6, category: 'law', subcategory: 'clat', isNew: true, difficulty: 'Moderate', questions: 150, duration: '2 hrs', language: ['English'] },
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex items-center gap-2">
                  <span className="px-3 py-1 rounded-full bg-gradient-to-r from-amber-400 to-orange-400 text-amber-900 text-xs font-bold flex items-center gap-1">
                    <Sparkles className="w-3 h-3" /> 2026 Updated
                  </span>
