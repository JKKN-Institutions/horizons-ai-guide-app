  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-900 via-green-900 to-emerald-950">
        ...
        <div className="absolute bottom-0 right-0 w-[60vw] max-w-[400px] h-[400px] bg-gradient-to-tr from-emerald-400/10 to-teal-500/5 rounded-full blur-3xl transform translate-x-1/3 translate-y-1/3" />
      </div>
