...
export const NAMAKKAL_FEATURED_COLLEGES: College[] = [
  ...
  // ============ SALEM DISTRICT COLLEGES ============
  
  // Government Colleges - Salem
  {
  ...
  {
    id: 'govt_college_women_salem',
    name: 'Government College for Women, Salem',
    type: 'government',
    category: 'arts_science',
    naacGrade: 'B++',
    establishedYear: 1965,
  ...
  {
    id: 'salem_sowdeshwari_college',
    name: 'Salem Sowdeshwari College',
    type: 'private',
    category: 'arts_science',
    naacGrade: 'B+',
