...
export const NAMAKKAL_FEATURED_COLLEGES: College[] = [
  ...
  // Government Colleges - Erode
  {
    id: 'govt_arts_college_erode',
    name: 'Government Arts College, Erode',
    type: 'government',
    category: 'arts_science',
    naacGrade: 'B++',
    establishedYear: 1967,
    courses: 'B.A, B.Sc, B.Com, M.A, M.Sc, M.Com',
    contact: '0424-2212345',
    feeRange: '₹1,000 - ₹5,000 per year',
    accreditation: 'Bharathiar University Affiliated',
    address: 'Erode',
  },
  {
    id: 'govt_arts_college_women_erode',
    name: 'Government Arts College for Women, Erode',
    type: 'government',
    category: 'arts_science',
    naacGrade: 'B+',
    establishedYear: 1975,
    courses: 'B.A, B.Sc, B.Com, BCA',
    contact: '0424-2213456',
    feeRange: '₹1,000 - ₹5,000 per year',
    accreditation: 'Bharathiar University Affiliated',
    address: 'Erode',
  },
  {
    id: 'ims_erode_medical',
    name: 'IRT Perundurai Medical College & Hospital',
    type: 'government',
    category: 'medical',
    naacGrade: 'A',
    establishedYear: 2015,
  ...
  },
  {
    ...
    name: 'J.K.K. Munirajah Vellore College of Arts and Science',
    type: 'private',
    category: 'arts_science',
    establishedYear: 1994,
    courses: 'B.Sc, B.Com, BCA, BBA, M.Sc, M.Com',
