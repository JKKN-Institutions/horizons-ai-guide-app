  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden" id="jobs">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-800 via-green-800 to-emerald-900">
        ...
        <div className="absolute top-0 left-0 w-[70vw] max-w-[500px] h-[500px] bg-gradient-to-br from-amber-400/10 to-orange-500/5 rounded-full blur-3xl transform -translate-x-1/3 -translate-y-1/3" />
        <div className="absolute bottom-0 right-0 w-[60vw] max-w-[400px] h-[400px] bg-gradient-to-tl from-emerald-400/10 to-teal-500/5 rounded-full blur-3xl transform translate-x-1/3 translate-y-1/3" />
      </div>
