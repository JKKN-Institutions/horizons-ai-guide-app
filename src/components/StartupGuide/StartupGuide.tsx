  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center space-y-2">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-600 to-amber-600 text-white px-5 py-2 rounded-full text-xs font-semibold shadow-lg shadow-orange-500/20 border border-orange-400/20">
          <Rocket className="w-3.5 h-3.5" />
          Complete Entrepreneurship Guidance System
        </div>
        <h2 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-orange-700 via-orange-600 to-amber-600 bg-clip-text text-transparent">
      ...
      <div className="grid grid-cols-4 gap-2">
        <Card className="text-center p-2 border-orange-200/50 bg-gradient-to-br from-orange-50/50 to-white shadow-sm">
          <div className="flex items-center justify-center gap-1 text-orange-600">
            <Zap className="w-3.5 h-3.5" />
            <span className="text-sm font-bold">{progress.xp}</span>
          </div>
          <p className="text-[10px] text-orange-700/60 font-medium">XP</p>
        </Card>
        ...
        <Card className="text-center p-2 border-amber-200/50 bg-gradient-to-br from-amber-50/50 to-white shadow-sm">
          ...
          <p className="text-[10px] text-amber-700/60 font-medium">Lessons</p>
        </Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full flex overflow-x-auto gap-0.5 bg-orange-50/80 p-1 h-auto flex-wrap border border-orange-100/60 rounded-xl">
          <TabsTrigger value="learn" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">📚 Learn</TabsTrigger>
          <TabsTrigger value="discover" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">🔍 Discover</TabsTrigger>
          <TabsTrigger value="quiz" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">💰 Quiz</TabsTrigger>
          <TabsTrigger value="simulate" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">🎮 Simulate</TabsTrigger>
          <TabsTrigger value="mentors" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">👥 Mentors</TabsTrigger>
          <TabsTrigger value="readiness" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">📊 Score</TabsTrigger>
          <TabsTrigger value="launch" className="text-[11px] flex-1 min-w-[60px] px-2 data-[state=active]:bg-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md rounded-lg transition-all">🚀 Launch</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="readiness" className="space-y-4 mt-4">
          <Card className="border-border/50">
            <CardContent className="p-4 space-y-4">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-orange-100 to-amber-50 border-2 border-orange-400/40 shadow-lg shadow-orange-500/10 mb-2">
                  <span className="text-2xl font-bold bg-gradient-to-br from-orange-700 to-amber-600 bg-clip-text text-transparent">{progress.overallScore}</span>
                </div>
          ...
          {/* Journey Stages */}
          <div>
            <h3 className="text-sm font-bold bg-gradient-to-r from-orange-700 to-amber-600 bg-clip-text text-transparent mb-2">Your Journey Progress</h3>
            <div className="space-y-2">
              {journeyStages.map((stage) => {
                ...
                return (
                  <button
                    key={stage.id}
                    className={`w-full text-left p-3 rounded-lg border transition-all flex items-center gap-3 ${isActive ? 'border-orange-400/50 bg-orange-50/50 shadow-sm shadow-orange-500/10' : isLocked ? 'border-border/30 opacity-50' : 'border-orange-500/30 bg-orange-500/5'}`}
                    onClick={() => setExpandedStage(isOpen ? null : stage.id)}
                  >
                    <div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold ${isDone ? 'bg-orange-500/10 text-orange-600' : isActive ? 'bg-orange-100 text-orange-700' : 'bg-muted text-muted-foreground'}`}>
                    ...
                    {isActive && <Badge className="text-[10px] bg-orange-100 text-orange-700 border border-orange-200/60">Current</Badge>}
                  </button>
                );
              })}
            </div>
        ...
        <TabsContent value="launch" className="space-y-3 mt-4">
          <div className="text-center mb-2 bg-gradient-to-r from-orange-50/80 to-amber-50/80 rounded-xl p-4 border border-orange-100/50">
            <h3 className="text-sm font-bold bg-gradient-to-r from-orange-700 to-amber-600 bg-clip-text text-transparent">Real-World Launchkit</h3>
            <p className="text-[10px] text-orange-600/70">Step-by-step guidance to start a business in India</p>
          </div>
          ...
          {[
            ...
            <Card key={i} className="border-orange-100/60 hover:border-orange-300/60 hover:shadow-md hover:shadow-orange-500/5 transition-all duration-200">
              <CardContent className="p-3 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-gradient-to-br from-orange-600 to-amber-600 text-white flex-shrink-0 shadow-md shadow-orange-500/20">
                  {guide.icon}
                </div>
                <div className="flex-1 min-w-0">
