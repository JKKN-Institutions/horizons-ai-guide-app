          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-2">
              {scenario.choices.map((choice) => {
                ...
                if (showResult) {
                  if (choice.isOptimal) className += 'border-emerald-500 bg-emerald-500/5';
                    ...
                    {showResult && (isSelected || choice.isOptimal) && (
                      <div className="mt-2 space-y-1">
                        ...
                        <div className="flex gap-2">
                          <Badge className={`text-[10px] ${choice.cashImpact >= 0 ? 'bg-emerald-500/10 text-emerald-600' : 'bg-destructive/10 text-destructive'}`}>
                          ...
                          <Badge className={`text-[10px] ${choice.moraleImpact >= 0 ? 'bg-emerald-500/10 text-emerald-600' : 'bg-destructive/10 text-destructive'}`}>
