...
export const entranceExams: EntranceExam[] = [
  ...
  // ============ MANAGEMENT & LAW ============
  {
    ...
    duration: '2 hours',
    syllabus: [
      'English Language – ~24 Q (Comprehension, inference, vocabulary from 450-word passages)',
      'Current Affairs incl. GK – ~28 Q (News-based passages, contemporary events, arts & culture, international affairs)',
      'Legal Reasoning – ~28 Q (Fact scenarios, identify rules/principles, apply to situations, no prior law knowledge needed)',
      'Logical Reasoning – ~26 Q (Arguments, premises, conclusions, analogies, contradictions, critical analysis)',
      'Quantitative Techniques – ~14 Q (Ratios, proportions, basic algebra, mensuration, statistical estimation – 10th standard level)',
      'Total: 120 MCQs | 120 Marks | -0.25 Negative Marking',
    ],
    eligibility: [
